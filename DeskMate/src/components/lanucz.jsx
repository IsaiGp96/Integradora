            ...
            <card className="flex-col max-w-6xl mx-auto space-y-4 ">
                <div className="white rounded-lg py-6 p-3">
                    <div className="text-center">
                        ㅤ<h1 className='animate-bounce tracking-wide text-5xl -mt-8' id='word'></h1>
                    </div>
                    <div className="mx-auto mt-6 flex justify-center">
                        <span className="inline-block h-1 w-40 rounded-full bg-blue-500" />
                        <span className="mx-1 inline-block h-1 w-40 rounded-full bg-blue-500" />
                    </div>
                </div>
            </card>
            <div>
                <section className="bg-white rounded-lg bg-azul">
                    <div className="container mx-auto px-6 py-10">
                        <h1 className="text-center text-3xl font-semibold capitalize text-gray-800 dark:text-white lg:text-4xl tracking-wide">Historia</h1>
                        ...
                        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-12 xl:grid-cols-3 xl:gap-12">
                            <div>
                                ...
                                <h2 className="mt-4 text-2xl font-semibold capitalize text-gray-800 dark:text-white">Misión</h2>
                                <p className="mt-2 text-lg text-justify uppercase tracking-wider text-blue-500 dark:text-blue-400">{mision}</p>
                            </div>
                            <div>
                                ...
                                <h2 className="mt-4 text-2xl font-semibold capitalize text-gray-800 dark:text-white">Visión</h2>
                                <p className="mt-2 text-lg text-justify uppercase tracking-wider text-blue-500 dark:text-blue-400">{vision}</p>
                            </div>
                            <div>
                                ...
                                <h2 className="mt-4 text-2xl font-semibold capitalize text-gray-800 dark:text-white">Valores</h2>
                                <ul className="mt-2 text-lg uppercase tracking-wider text-blue-500 dark:text-blue-400">
                                    {valores.map((valor, index) => <li key={index}>{valor}</li>)}
                                </ul>
                            </div>
                        </div>
                        <h1 className="text-center text-3xl font-semibold capitalize text-gray-800 dark:text-white lg:text-4xl tracking-wide">Políticas</h1>
                ...
                <section className="mt-6 rounded-lg bg-white bg-azul">
                    <div className="rounded-lg h-[25rem]">
                        <div className="container mx-auto px-6 py-10">
                            <h1 className="text-center text-3xl font-semibold  text-gray-800 dark:text-white lg:text-4xl">Miembros del equipo</h1>
                            <div className="mx-auto mt-6 flex justify-center">
                                <span className="inline-block h-1 w-40 rounded-full bg-blue-500" />
                    ...
                    <div className="container mx-auto  px-6 py-10 sm:-mt-80 md:-mt-96">
                        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-16 xl:grid-cols-4">
                            <div className="flex flex-col items-center rounded-xl border p-4 dark:border-gray-950 sm:p-6">
                                ...
                                <h1 className="mt-4 text-2xl font-semibold capitalize text-gray-700 dark:text-white">Alan Enrique</h1>
                                <p className="mt-2 capitalize text-gray-500 dark:text-gray-300">Diseño electronico/backend</p>
                            ...
                            <div className="flex flex-col items-center rounded-xl border p-4 dark:border-gray-950 sm:p-6">
                                ...
                                <h1 className="mt-4 text-2xl font-semibold capitalize text-gray-700 dark:text-white">Samantha Martinez</h1>
                            ...
                            <div className="flex flex-col items-center rounded-xl border p-4 dark:border-gray-950 sm:p-6">
                                ...
                                <h1 className="mt-4 text-2xl font-semibold capitalize text-gray-700 dark:text-white">Abraham García</h1>
                                <p className="mt-2 capitalize text-gray-500 dark:text-gray-300">Full stack developer</p>
                                <div className="-mx-2 mt-3 flex">
                                    <a href="#" className="mx-2 text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Reddit">
                                        <svg className="h-6 w-6 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="flex flex-col items-center rounded-xl border p-4 dark:border-gray-950 sm:p-6">
                                ...
                                <h1 className="mt-4 text-2xl font-semibold capitalize text-gray-700 dark:text-white">Carlos Diaz</h1>
                                <p className="mt-2 capitalize text-gray-500 dark:text-gray-300">Frontend developer</p>
                                <div className="-mx-2 mt-3 flex">
                                    <a href="#" className="mx-2 text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Reddit">
                                        <svg className="h-6 w-6 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        </svg>
